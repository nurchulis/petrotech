...
@section('content')
    <div class="d-flex justify-content-between align-items-center mb-4">
        ...
        <span class="badge bg-{{ $vm->status_badge }} p-2 text-white">{{ ucfirst($vm->status) }}</span>
    </div>
    ...
    <div class="row g-3">
                ...
                <div class="alert alert-info border-0 shadow-sm mb-0">
                    <div class="d-flex">
                        ...
                        <div>
                            ...
                            <div class="text-muted">No metrics recorded for this VM in the last 24 hours. Please check the
                                monitoring agent status or generate test data.</div>
                        </div>
                    </div>
                </div>
            </div>
        @else
            <div class="col-lg-6">
                <div class="card border-0 shadow-sm">
                    <div class="card-header bg-white border-0">
                        <h4 class="card-title mb-0">CPU Usage (24h)</h4>
                    </div>
                    <div class="card-body">
            ...
            <div class="col-lg-6">
                <div class="card border-0 shadow-sm">
                    <div class="card-header bg-white border-0">
                        <h4 class="card-title mb-0">Memory Usage (24h)</h4>
                    </div>
                    <div class="card-body">
            ...
            <div class="col-lg-6">
                <div class="card border-0 shadow-sm">
                    <div class="card-header bg-white border-0">
                        <h4 class="card-title mb-0">Disk I/O Read (24h)</h4>
                    </div>
                    <div class="card-body">
            ...
            <div class="col-lg-6">
                <div class="card border-0 shadow-sm">
                    <div class="card-header bg-white border-0">
                        <h4 class="card-title mb-0">Network In (24h)</h4>
                    </div>
                    <div class="card-body">
            ...
            @if($vm->has_gpu)
                <div class="col-12">
                    <div class="card border-0 shadow-sm">
                        <div class="card-header bg-white border-0">
                            <h4 class="card-title mb-0">GPU Utilisation (24h)</h4>
                        </div>
                        <div class="card-body">
