...
<div class="d-flex justify-content-between align-items-center mb-4">
    ...
    <button class="btn" style="background:#1a3c6b;color:#fff" data-bs-toggle="modal" data-bs-target="#createVendorModal">+ Add Vendor</button>
    @endcan
</div>
                    ...
                    <div class="mb-3">
                        ...
                        <select class="form-select" name="license_server_id" required>
                            ...
                            @foreach(\App\Models\LicenseServer::all() as $server)
                                <option value="{{ $server->id }}">{{ $server->server_name }} ({{ $server->ip_address }})</option>
                            @endforeach
                        </select>
                    </div>
                    <div class="mb-3">
